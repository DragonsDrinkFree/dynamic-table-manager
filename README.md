...
Table creation can be done manually, by copy & Past, or by selecting a local PDF and scanning tables directly from it. Multiple tables can be made simultaniously. Multi-column tables can be copy/pasted and automatically split into separate tables with a compound table created to roll on each table to produce a result.
